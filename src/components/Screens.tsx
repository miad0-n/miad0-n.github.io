...
export const ManifestoScreen: React.FC = () => {
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between max-w-6xl mx-auto py-4 text-[var(--c-text)]">
      <div className="space-y-4">
        <span className="font-mono text-[10px] text-[#FF5701] uppercase tracking-[0.25em] font-bold block">
          Hi, I'm Miad
        </span>
        <h1 className="font-serif font-bold text-[clamp(2.5rem,11vw,7rem)] leading-[0.85] tracking-tight text-[var(--c-text)] uppercase">
          NOT A PRO.<br />
          NOT A PRODIGY.<br />
        ...
        <p className="font-mono text-xs md:text-sm leading-relaxed text-[var(--c-muted)] max-w-[480px] text-justify mt-4">
      ...
      <div className="mt-8 border border-[var(--c-border)] bg-[var(--c-surface)] rounded-lg p-5 max-w-xl shadow-sm transition-colors duration-300 hover:border-[#FF5701]/30">
        <button
          onClick={() => setExpanded(!expanded)}
          className="w-full flex items-center justify-between font-mono text-[9.5px] uppercase tracking-widest text-[var(--c-text)] font-bold focus:outline-none cursor-pointer"
        >
          <span className="flex items-center gap-2">
            <BookOpen size={12} className="text-[#FF5701]" />
            {expanded ? 'HIDE CORE BLUEPRINTS' : 'EXPLORE CORE BLUEPRINTS'}
          </span>
          {expanded ? <ChevronUp size={14} className="text-[var(--c-text)]/60" /> : <ChevronDown size={14} className="text-[var(--c-text)]/60" />}
        </button>
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between max-w-6xl mx-auto py-4 text-[var(--c-text)]">
      <div className="mb-4">
        ...
        <h2 className="font-serif font-bold text-[clamp(2.2rem,7vw,4rem)] leading-none tracking-tight text-[var(--c-text)] mt-2 select-none uppercase">
          THE VOID.
        </h2>
        <p className="font-mono text-xs text-[var(--c-muted)] mt-2">
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between max-w-6xl mx-auto py-4 text-[var(--c-text)]">
      <div className="mb-2">
        ...
        <h2 className="font-serif font-bold text-[clamp(2.2rem,7vw,4rem)] leading-none tracking-tight text-[var(--c-text)] mt-1 select-none uppercase">
          SYSTEM<br />
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between max-w-6xl mx-auto py-4 text-[var(--c-text)]">
      <div className="mb-4">
        ...
        <h2 className="font-serif font-bold text-[clamp(2.2rem,7vw,4rem)] leading-[0.9] tracking-tight text-[var(--c-text)] mt-2 select-none uppercase">
          STUDENT.<br />
          EXPLORER.<br />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mt-3">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
          <div className="space-y-4 border-t border-[var(--c-border)] pt-4">
            <span className="font-mono text-[9.5px] uppercase tracking-widest text-[var(--c-text)]/80 font-bold block">
              PROCRASTINATION_LOG
            </span>
            <div className="space-y-4 max-h-[190px] md:max-h-[220px] overflow-y-auto pr-2">
              {EXPERIENCE.map((exp, i) => (
                <div key={i} className="relative pl-4 border-l-2 border-[var(--c-border)] hover:border-[#FF5701] transition-all duration-300">
                  <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center gap-1.5 mb-1.5">
                    <span className="font-mono text-[9px] text-[var(--c-text)] font-bold uppercase">
                      {exp.role}
                    </span>
                  ...
                  <span className="font-serif text-xs text-[var(--c-muted)] italic block mb-1">
                    {exp.institution}
                  </span>
                  <p className="font-mono text-[9.5px] leading-relaxed text-[var(--c-muted)] text-justify">
                    {exp.description}
                  </p>
                </div>
              ))}
    ...
    <div className="w-full flex-1 flex flex-col justify-between max-w-6xl mx-auto py-4 text-[var(--c-text)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-stretch mt-4">
        ...
        <div className="lg:col-span-6 flex flex-col justify-between">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 border-t border-[var(--c-border)] pt-4 mt-6 select-none opacity-40">
